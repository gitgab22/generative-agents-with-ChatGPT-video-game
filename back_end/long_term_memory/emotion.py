...
class Emotion:
    ...
    #Print the emotionnal state. To use for CHATGPT.
    ...
    #Given the CHATGPT response it updates the emotionnal state. Used in the update function.
    ...
    #To manually reset all emotions
    ...
    #Gives the history of on emotion
    def get_emotion_history(self, emotion):
        return self.history[emotion]

    #Gives the history of the emotionnal state
    ...
    ''' 
    We will use that later in the project if necessary
